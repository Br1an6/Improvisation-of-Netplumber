...
struct probe_counter_t  int start_True
  int start_False
  int True_to_False
  int False_to_True
  int more_True
...
class NetPlumberPlumbingTest : public CppUnit.TestFixture  CPPUNIT_TEST_SUITE(NetPlumberPlumbingTest)
 ...
 private:
  ...
  void check_probe_counter(probe_counter_t result, expected)
