...
namespace netstring
  ...
  std.string decode( std.string& str) throw(netstring.NetstringException) 
    unsigned len = 0
    index = 0; ''' position of ":" '''
    index2 = 0; ''' position of "," '''
    i = 0
     data = str.data()
    std.string ret
  ...
  NetstringException.NetstringException( std.string& msg) throw()
    m_msg = msg
  ...
  NetstringException.~NetstringException() throw()
   ...
   char* NetstringException.what()  throw()
    return m_msg.c_str()
